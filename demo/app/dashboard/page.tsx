...
export default function MobileDashboard() {
  const upcomingTrips: Trip[] = [
    {
      ...
      organizers: [{ name: 'Mike Johnson', avatar: 'https://avatar.vercel.sh/mike' }],
      isOrganizing: false,
      rsvpStatus: 'going',
      eventCount: 15,
    },
    ...
    },
    {
      ...
      organizers: [{ name: 'Emily Parker', avatar: 'https://avatar.vercel.sh/emily' }],
      isOrganizing: false,
      rsvpStatus: 'maybe',
      eventCount: 0,
    },
  ...
  const pastTrips: Trip[] = [
    {
      ...
      startDate: 'Mar 15',
      endDate: 'Mar 18, 2026',
      coverImage: 'https://images.unsplash.com/photo-1605833556294-ea5c7a74f57d',
      organizers: [{ name: 'Mike Johnson', avatar: 'https://avatar.vercel.sh/mike' }],
      isOrganizing: false,
      rsvpStatus: 'going',
      eventCount: 12,
  ...
  const getRsvpBadge = (status?: string) => {
    switch (status) {
      case 'going':
        return <Badge className="bg-emerald-100 text-emerald-700 border-emerald-200">Going</Badge>;
      case 'maybe':
        return <Badge className="bg-amber-100 text-amber-700 border-amber-200">Maybe</Badge>;
      case 'not_going':
        return (
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-amber-50/30 pb-20">
        ...
        <div className="max-w-2xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-slate-600 mt-1">{upcomingTrips.length} upcoming</p>
            </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-8">
        {/* Upcoming trips */}
        <section>
          <h2 className="text-xl font-semibold text-slate-900 mb-4">Upcoming trips</h2>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-slate-100">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-slate-600">
                        ...
                        {trip.organizers.length > 1 && ` +${trip.organizers.length - 1}`}
                      </span>
                    </div>
                    ...
                    <div className="flex items-center gap-1 text-xs text-slate-600">
                      ...
                      <span>
                        {trip.eventCount === 0 ? 'No events yet' : `${trip.eventCount} events`}
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="p-4 space-y-3">
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-slate-600 truncate mb-2">{trip.destination}</p>
