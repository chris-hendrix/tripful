...
export default function TripPreviewScreen() {
  const trip = {
    ...
    endDate: 'Oct 14, 2026',
    description:
      "Three days of sun, fun, and unforgettable memories. We've got beach clubs, boat day, and nightlife planned. Optional activities for those who want a more chill vibe.",
        ...
        <div className="space-y-12">
          ...
          <div className="relative rounded-2xl border-2 border-dashed border-slate-300 bg-slate-50/50 p-12 text-center space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-500">
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-600 max-w-md mx-auto">
                Let the organizers know if you're coming to unlock access to the day-by-day
                schedule, activities, and all trip details.
              </p>
            </div>
          </div>
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-500">
            <div className="bg-white rounded-2xl border border-slate-200 shadow-lg p-8 space-y-6">
              <div className="space-y-2">
                <h3 className="text-xl font-semibold text-slate-900">Will you be attending?</h3>
                <p className="text-sm text-slate-600">Your response helps organizers plan ahead</p>
              </div>

              <div className="space-y-3">
                <Button className="w-full h-14 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-semibold text-lg rounded-xl shadow-lg shadow-blue-500/30 transition-all duration-200 hover:shadow-xl hover:shadow-blue-500/40">
                  <svg
            ...
            <div className="mt-6 bg-gradient-to-br from-slate-100 to-blue-100/50 rounded-2xl border border-slate-200 p-6 space-y-4">
              ...
              <p className="text-sm text-slate-600">Share this trip with friends who should join</p>
              <Button
                variant="outline"
