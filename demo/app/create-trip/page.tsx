      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-3">
            <span className="text-sm font-medium text-slate-900">Create your trip</span>
        ...
        <div className="space-y-8">
            ...
            <form className="space-y-6">
              {/* Trip Name */}
              <Field>
                <FieldLabel htmlFor="trip-name" className="text-base font-semibold text-slate-900">
                  Trip name
              ...
              {/* Destination */}
              <Field>
                <FieldLabel htmlFor="destination" className="text-base font-semibold text-slate-900">
                  Destination
                  <span className="text-red-500 ml-1">*</span>
                </FieldLabel>
                <Input
              ...
              <div className="grid grid-cols-2 gap-4">
                <Field>
                  <FieldLabel htmlFor="start-date" className="text-base font-semibold text-slate-900">
                    Start date
                  </FieldLabel>
                  <Input
                    id="start-date"
                ...
                <Field>
                  <FieldLabel htmlFor="end-date" className="text-base font-semibold text-slate-900">
                    End date
                  </FieldLabel>
                  <Input
                    id="end-date"
              ...
              {/* Timezone */}
              <Field>
                <FieldLabel htmlFor="timezone" className="text-base font-semibold text-slate-900">
                  Trip timezone
                  <span className="text-red-500 ml-1">*</span>
                </FieldLabel>
                <Select value={timezone} onValueChange={setTimezone}>
                  <SelectTrigger id="timezone" className="h-12 text-base rounded-xl">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              {/* Description */}
              <Field>
                <FieldLabel htmlFor="description" className="text-base font-semibold text-slate-900">
                  Description
