  ...
  const events: TripEvent[] = [
    {
      ...
      location: "JFK → MIA",
      description:
        "American Airlines flight. Gate B12, Terminal 4. Check in 24hrs before.",
    ...
    },
    {
      ...
      description:
        "Alternative option for those not doing the yacht. Reserved daybed section.",
      createdBy: alex,
      isOptional: true,
    ...
    },
    {
      ...
      description:
        "3.5 hour scenic drive down the Overseas Highway. Bring snacks for the road!",
    ...
    },
    {
      ...
      description:
        "Waterfront dining on a private island. Boat shuttle from marina included.",
    ...
    },
    {
      ...
      description:
        "Head back to Miami for evening flights. Allow 4 hours with stops.",
      createdBy: mike,
    },
    {
      id: "11",
                  ...
                  {(() => {
                    ...
                    return regularEventCount > 0 ? (
                      <div className="inline-flex items-center gap-1.5 bg-slate-100 rounded-full px-3 py-1 text-xs font-medium text-slate-700">
                        ...
                        <span>
                          {regularEventCount}{" "}
                          {regularEventCount === 1 ? "event" : "events"}
                        </span>
                      </div>
                    ) : null;
                  })()}
                                          ...
                                          <>
                                            <span className="text-xs text-slate-600 flex-shrink-0">
                                              {event.location.includes("→")
                                                ? event.location
                                                    .split("→")[0]
                                                    .trim() // For departures, show origin (where they're leaving from)
                                                : event.location}
                                            </span>
                                            <span className="text-slate-400 flex-shrink-0">
                                              •
