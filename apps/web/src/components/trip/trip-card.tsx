...
export const TripCard = memo(function TripCard({
  ...
  return (
    <Link
      ...
      className="block bg-card rounded-2xl overflow-hidden border border-border shadow-sm hover:shadow-md active:scale-[0.98] transition-all cursor-pointer motion-safe:animate-[slideUp_500ms_ease-out_both] motion-safe:hover:-translate-y-0.5"
